...
def main():
    ...
    parser.add_argument('--train_content_dir', type=str, default='/hy-tmp/test2015',
                        help='content images directory for train')
    parser.add_argument('--train_style_dir', type=str, default='/hy-tmp/WikiArt2',
                        help='style images directory for train')
    parser.add_argument('--test_content_dir', type=str, default='/hy-tmp/test2015',
                        help='content images directory for test')
    parser.add_argument('--test_style_dir', type=str, default='/hy-tmp/WikiArt2',
                        help='style images directory for test')
    parser.add_argument('--save_dir', type=str, default='/hy-tmp/result_source',
