...
def main():
    ...
    parser.add_argument('--content', '-c', type=str, default="/root/test_content_style/content_2.jpg",
                        help='Content image path e.g. content.jpg')
    parser.add_argument('--style', '-s', type=str, default="/root/test_content_style/style_1.jpg",
                        help='Style image path e.g. image.jpg')
    parser.add_argument('--output_name', '-o', type=str, default="/root/res/2_1",
    ...
    parser.add_argument('--model_state_path', type=str, default='/hy-tmp/result/model_state/2_epoch.pth',
