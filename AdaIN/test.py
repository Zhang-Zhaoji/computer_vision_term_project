...
def main():
    ...
    parser.add_argument('--content', '-c', type=str, default="images/Tuebingen_Neckarfront.jpg",
                        help='Content image path e.g. content.jpg')
    parser.add_argument('--style', '-s', type=str, default="images/vangogh_starry_night.jpg",
    ...
    parser.add_argument('--model_state_path', type=str, default='./result/model_state/9_epoch.pth',
