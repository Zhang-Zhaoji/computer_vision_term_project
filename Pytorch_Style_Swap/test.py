...
def main():
    ...
    parser.add_argument('--content', '-c', type=str, default="test_content/toque1024.jpg",
                        help='Content image path e.g. content.jpg')
    parser.add_argument('--style', '-s', type=str, default="test_style/483px-Mona_Lisa,_by_Leonardo_da_Vinci,_from_C2RMF_retouched.jpg",
    ...
    for cn in content_names:
        for sn in style_names:
            try:
                c = Image.open(content_dir+cn)
                s = Image.open(style_dir+sn)
