...
from monodepth import load_model, depth_loss
...
def main():
    ...
    parser.add_argument('--test_content_dir', type=str, default='another_train',
    ...
    parser.add_argument('--reuse', default="./result/model_state/9_epoch.pth",
    ...
    for e in range(1, args.epoch + 1):
        ...
        for i, (content, style) in tqdm(enumerate(train_loader, 1)):
            ...
            deep_loss = depth_loss(out,content,encoder,depth_decoder,feed_width,feed_height)
            
            loss = model(content, style) + deep_loss
        ...
        torch.save(model.state_dict(), f'{model_state_dir}/{e+7}_epoch.pth')
